...
u(x,y) = y*(1-y);
v(x,y) = 0;
p(x,y) = 2*Problem.Geometry_param - 4*x;
...
BC = [BC, struct('start', [umin,vmin], 'stop', [umax,vmin], 'comp', 2, 'value', 0)];                % bottom
BC = [BC, struct('start', [umin,vmax], 'stop', [umax,vmax], 'comp', 2, 'value', 0)];                % top
BC = [BC, struct('start', [umin,vmin], 'stop', [umin,vmax], 'comp', 1, 'value', Exact_solution.u)]; % left 
BC = [BC, struct('start', [umax,vmin], 'stop', [umax,vmax], 'comp', 1, 'value', Exact_solution.u)]; % right

BC = [BC, struct('start', [umin,vmin], 'stop', [umax,vmin], 'comp', 1, 'value', 0)]; % bottom
BC = [BC, struct('start', [umin,vmax], 'stop', [umax,vmax], 'comp', 1, 'value', 0)]; % top
BC = [BC, struct('start', [umin,vmin], 'stop', [umin,vmax], 'comp', 2, 'value', 0)]; % left 
BC = [BC, struct('start', [umax,vmin], 'stop', [umax,vmax], 'comp', 2, 'value', 0)]; % right
...
BC = [BC, struct('start', [umin,vmin], 'stop', [umin,vmin], 'comp', 3, 'value',  2*Problem.Geometry_param*detJ)]; % bottom-left
BC = [BC, struct('start', [umax,vmin], 'stop', [umax,vmin], 'comp', 3, 'value', -2*Problem.Geometry_param*detJ)]; % bottom-right
BC = [BC, struct('start', [umin,vmax], 'stop', [umin,vmax], 'comp', 3, 'value',  2*Problem.Geometry_param*detJ)]; % top-left
BC = [BC, struct('start', [umax,vmax], 'stop', [umax,vmax], 'comp', 3, 'value', -2*Problem.Geometry_param*detJ)]; % top-right
